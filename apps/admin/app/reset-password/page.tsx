...
export default function ResetPasswordPage() { return <AuthShell eyebrow="Account recovery" title="Choose a new password." description="Use a new password to keep your workspace secure."><Suspense><ResetForm /></Suspense></AuthShell>; }
