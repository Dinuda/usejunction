...
export default async function JoinPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return <AuthFrame eyebrow="Workspace invitation" title={invalid ? "This invitation is unavailable" : `Join ${invite.organization.name}`} description={invalid ? "This link can no longer be used." : "Join your team workspace, then connect your computer in the next step."}>
