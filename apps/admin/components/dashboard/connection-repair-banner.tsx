...
import { RepairConnectionDialog } from "@/components/dashboard/repair-connection-dialog";
  ...
  return (
    <>
      ...
      <RepairConnectionDialog
        device={repairDevice ? { id: repairDevice.id, hostname: repairDevice.hostname } : null}
        onOpenChange={(open) => {
